...
\keywords{<<Лиганд -- Белок>> \*\ Скоринг функции \*\ Свободная энергия связывания \*\ Классификация \*\ Регрессия \*\ Лиганд}
...
&$y_{i}[\mathbf{w}^T\mathbf{X}_{i} - b_i]-1+\xi_{i} \geq 0$\\%, ~ i=1...P,~j=1...D$ \\
&$\xi_{i} \geq 0$
\end{tabular}
\label{eq:primal} 
\end{eqnarray}
